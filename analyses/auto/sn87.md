# Subnet 87 — Luminar Network

> Auto-analyzed: 2026-05-08 06:05 PDT · easy-entry score: 30.2/100 · refreshes hourly
...
| Emission / day | 53.7775 τ |
| Top-1 share | 100.0% |
| Liquidity (TAO in) | 1,255.1 τ |
| Price (τ/α) | 0.004979 |
| Age | 129 days |
...
|---|:-:|---|---|
| Registration burn fee (one-time per UID) | ✓ | $0.31 – $0.37 | 0.0010 τ · @ $307.36/τ · includes ~20% buffer for fee jitter |
...
5. `btcli subnet register --netuid 87 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- Website: <https://luminar.network/>
- Discord: <https://x.com/LuminarNetwork>
- TAO.app: <https://tao.app/subnet/87>
