...
| Burn fee | 0.001280 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.001000 τ → 100.0000 τ |
| Emission / day | 30.3420 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 1,699.2 τ |
| Price (τ/α) | 0.004214 |
| Age | 181 days |


> **Trend (from 98 snapshots):** Burn fee has risen ~28% over the last 98 snapshots.

## Easy-entry score: 24 / 100  🔴 low

- subnet is FULL (eviction war)
- cheap burn fee 0.0013 τ
...
**Monthly recurring:** ~$50 – $1,500 · **One-time setup:** ~$0.27 – $0.32
...
|---|:-:|---|---|
| Registration burn fee (one-time per UID) | ✓ | $0.27 – $0.32 | 0.0013 τ · @ $209.12/τ · includes ~20% buffer for fee jitter |
...
3. Fund with burn fee + buffer (~0.0015 τ recommended).
