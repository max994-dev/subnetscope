...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 19.6/100 · refreshes hourly
...
| Burn fee | 0.000895 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.000500 τ → 100.0000 τ |
| Emission / day | 105.8548 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 4,730.7 τ |
| Price (τ/α) | 0.014702 |
| Age | 171 days |


> **Trend (from 98 snapshots):** Burn fee has risen ~79% over the last 98 snapshots.

## Easy-entry score: 20 / 100  🔴 low

- heavy GPU need
- subnet is FULL (eviction war)
- cheap burn fee 0.0009 τ
...
|---|:-:|---|---|
| Registration burn fee (one-time per UID) | ✓ | $0.19 – $0.22 | 0.0009 τ · @ $209.12/τ · includes ~20% buffer for fee jitter |
...
3. Fund with burn fee + buffer (~0.0011 τ recommended).
4. Clone the subnet repo, run the miner in test mode first.
5. `btcli subnet register --netuid 38 --wallet.name <cold> --wallet.hotkey <hot>`
...
- TAO.app: <https://tao.app/subnet/38>
