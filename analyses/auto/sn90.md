...
| Burn fee | 0.000611 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.000500 τ → 100.0000 τ |
| Emission / day | 23.6400 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 1,982.7 τ |
| Price (τ/α) | 0.003283 |
| Age | 201 days |
...
5. `btcli subnet register --netuid 90 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- TAO.app: <https://tao.app/subnet/90>
