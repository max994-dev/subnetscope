...
| Emission / day | 25.3461 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 9,358.2 τ |
| Price (τ/α) | 0.003520 |
| Age | 713 days |
...
5. `btcli subnet register --netuid 29 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- GitHub: <https://github.com/coldint/hotfloat>
- Website: <http://hotfloat.io>
- TAO.app: <https://tao.app/subnet/29>
