...
> Auto-analyzed: 2026-05-08 06:05 PDT · easy-entry score: 19.5/100 · refreshes hourly
...
| Emission / day | 28.7558 τ |
| Top-1 share | 92.5% |
| Liquidity (TAO in) | 4,219.6 τ |
| Price (τ/α) | 0.003994 |
| Age | 328 days |
...
**Monthly recurring:** ~$50 – $1,500 · **One-time setup:** ~$0.31 – $0.37
...
5. `btcli subnet register --netuid 122 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- GitHub: <https://github.com/bitrecs/bitrecs-v2>
- Website: <https://bitrecs.ai>
- Discord: <https://discord.gg/gWtKvytFma>
- TAO.app: <https://tao.app/subnet/122>
