...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 39.0/100 · refreshes hourly
...
| Emission / day | 34.9621 τ |
| Top-1 share | 11.8% |
| Liquidity (TAO in) | 8,176.0 τ |
| Price (τ/α) | 0.004401 |
| Age | 563 days |


> **Trend (from 98 snapshots):** Burn fee has fallen ~31% over the last 98 snapshots.

## Easy-entry score: 39 / 100  🔴 low

- top miner incentive only 12% (decentralized)
...
|---|---|
| GPU friction | 8.8 / 22 |
| Decentralization (top-1) | 17.6 / 20 |
| Active miners | 0.8 / 16 |
| Free slots | 0.0 / 13 |
| Burn fee | 11.0 / 11 |
| Liquidity | 0.4 / 10 |
| Emission | 0.4 / 8 |
...
**Top-N rewards:** emission concentrates in the top ~10 miners. Breaking into the top tier is key; mid-pack earns modestly.
