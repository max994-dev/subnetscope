...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 31.3/100 · refreshes hourly
...
| Emission / day | 48.9593 τ |
| Top-1 share | 40.2% |
| Liquidity (TAO in) | 5,921.2 τ |
| Price (τ/α) | 0.005873 |
| Age | 481 days |
...
|---|---|
| GPU friction | 6.6 / 22 |
| Decentralization (top-1) | 12.0 / 20 |
...
5. `btcli subnet register --netuid 71 --wallet.name <cold> --wallet.hotkey <hot>`
...
- TAO.app: <https://tao.app/subnet/71>
