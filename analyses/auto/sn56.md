...
| Emission / day | 154.1974 τ |
| Top-1 share | 81.5% |
| Liquidity (TAO in) | 57,731.7 τ |
| Price (τ/α) | 0.021416 |
| Age | 531 days |


> **Trend (from 57 snapshots):** Active miner count has grown by 7 since the first recorded snapshot.

## Easy-entry score: 22 / 100  🔴 low

- heavy GPU need
- top1 takes 82% (winner-take-all)
...
5. `btcli subnet register --netuid 56 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- GitHub: <https://github.com/gradients-ai/G.O.D>
- Website: <https://www.gradients.io/>
- Discord: <None>
- TAO.app: <https://tao.app/subnet/56>
