...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 43.2/100 · refreshes hourly
...
| Emission / day | 66.5492 τ |
| Top-1 share | 2.7% |
| Liquidity (TAO in) | 14,660.7 τ |
| Price (τ/α) | 0.008013 |
| Age | 504 days |
...
5. `btcli subnet register --netuid 63 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- GitHub: <https://github.com/qbittensor-labs/enigma>
- Website: <https://www.qbittensorlabs.com/>
- Discord: <qbittensorlabs>
- TAO.app: <https://tao.app/subnet/63>
