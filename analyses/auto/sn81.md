...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 40.3/100 · refreshes hourly
...
| Emission / day | 65.8266 τ |
| Top-1 share | 7.6% |
| Liquidity (TAO in) | 19,611.7 τ |
| Price (τ/α) | 0.007833 |
| Age | 460 days |
...
|---|---|
| GPU friction | 6.6 / 22 |
| Decentralization (top-1) | 18.5 / 20 |
| Active miners | 2.5 / 16 |
| Free slots | 0.0 / 13 |
| Burn fee | 11.0 / 11 |
| Liquidity | 0.9 / 10 |
| Emission | 0.8 / 8 |
...
5. `btcli subnet register --netuid 81 --wallet.name <cold> --wallet.hotkey <hot>`
...
- Discord: <deprecated>
- TAO.app: <https://tao.app/subnet/81>
