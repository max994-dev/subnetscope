...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 20.6/100 · refreshes hourly
...
| Emission / day | 31.2457 τ |
| Top-1 share | 100.0% |
| Liquidity (TAO in) | 7,241.0 τ |
| Price (τ/α) | 0.004340 |
| Age | 444 days |


> **Trend (from 98 snapshots):** Burn fee has fallen ~68% over the last 98 snapshots.
...
5. `btcli subnet register --netuid 89 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- GitHub: <https://github.com/DeltaCompute24/InfiniteQuant-Subnet>
- Website: <https://infinitequant.app>
- TAO.app: <https://tao.app/subnet/89>
