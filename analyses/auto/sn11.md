...
> Auto-analyzed: 2026-05-08 06:05 PDT · easy-entry score: 14.0/100 · refreshes hourly
...
| Burn fee | 0.20000 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.20000 τ → 100.0000 τ |
| Emission / day | 64.1207 τ |
| Top-1 share | 95.7% |
| Liquidity (TAO in) | 20,844.1 τ |
| Price (τ/α) | 0.008906 |
| Age | 725 days |


## Easy-entry score: 14 / 100  🔴 low

- heavy GPU need
- top1 takes 96% (winner-take-all)
- subnet is FULL (eviction war)
- cheap burn fee 0.2000 τ
...
**Monthly recurring:** ~$1,500 – $3,500 · **One-time setup:** ~$8,061 – $35,074
...
|---|:-:|---|---|
| Registration burn fee (one-time per UID) | ✓ | $61 – $74 | 0.2000 τ · @ $307.36/τ · includes ~20% buffer for fee jitter |
...
3. Fund with burn fee + buffer (~0.2400 τ recommended).
4. Clone the subnet repo, run the miner in test mode first.
5. `btcli subnet register --netuid 11 --wallet.name <cold> --wallet.hotkey <hot>`
...
- TAO.app: <https://tao.app/subnet/11>
