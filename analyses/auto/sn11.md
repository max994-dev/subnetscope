...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 19.8/100 · refreshes hourly
...
| Burn fee | 0.02000 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.02000 τ → 100.0000 τ |
| Emission / day | 68.1159 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 20,082.0 τ |
| Price (τ/α) | 0.008205 |
| Age | 777 days |
...
**Monthly recurring:** ~$1,530 – $3,800 · **One-time setup:** ~$8,004 – $35,005
...
|---|:-:|---|---|
| Registration burn fee (one-time per UID) | ✓ | $4.18 – $5.02 | 0.0200 τ · @ $209.12/τ · includes ~20% buffer for fee jitter |
...
3. Fund with burn fee + buffer (~0.0240 τ recommended).
