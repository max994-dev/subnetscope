...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 39.4/100 · refreshes hourly
...
| Burn fee | 0.000610 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.000500 τ → 100.0000 τ |
| Emission / day | 24.6702 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 2,137.9 τ |
| Price (τ/α) | 0.003426 |
| Age | 222 days |
...
5. `btcli subnet register --netuid 86 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- TAO.app: <https://tao.app/subnet/86>
