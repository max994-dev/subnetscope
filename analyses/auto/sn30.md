...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 39.9/100 · refreshes hourly
...
| Emission / day | 32.4371 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 9,787.7 τ |
| Price (τ/α) | 0.004505 |
| Age | 731 days |
...
**Monthly recurring:** ~$5.00 – $220 · **One-time setup:** ~$0.10 – $0.13
...
5. `btcli subnet register --netuid 30 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- Website: <https://endure.network>
- TAO.app: <https://tao.app/subnet/30>
