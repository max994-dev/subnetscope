...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 24.3/100 · refreshes hourly
...
| Emission / day | 32.7755 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 6,990.6 τ |
| Price (τ/α) | 0.004552 |
| Age | 372 days |
...
5. `btcli subnet register --netuid 125 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- TAO.app: <https://tao.app/subnet/125>
