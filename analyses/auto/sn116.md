...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 33.6/100 · refreshes hourly
...
| Reward shape | ? |
| Active miners | — |
| UID slots | 84/256 (172 free) |
| Burn fee | 0.000612 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.000500 τ → 100.0000 τ |
| Emission / day | 94.5100 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 2,126.4 τ |
| Price (τ/α) | 0.013126 |
| Age | 30 days |
...
5. `btcli subnet register --netuid 116 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- TAO.app: <https://tao.app/subnet/116>
