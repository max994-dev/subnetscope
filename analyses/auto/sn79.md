...
| Burn fee | 0.01273 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.000500 τ → 100.0000 τ |
| Emission / day | 126.9005 τ |
| Top-1 share | 80.0% |
| Liquidity (TAO in) | 11,668.2 τ |
| Price (τ/α) | 0.011750 |
| Age | 412 days |
...
- top1 takes 80% (winner-take-all)
- subnet is FULL (eviction war)
- cheap burn fee 0.0127 τ

| Component | Score |
|---|---|
| GPU friction | 0.3 / 20 |
| Decentralization (top-1) | 0.2 / 20 |
| Active miners | 0.8 / 15 |
| Free slots | 0.0 / 15 |
| Burn fee | 1.0 / 15 |
| Liquidity | 0.1 / 10 |
| Emission | 0.2 / 5 |
...
**Monthly recurring:** ~$50 – $1,500 · **One-time setup:** ~$3.91 – $4.69
...
|---|:-:|---|---|
| Registration burn fee (one-time per UID) | ✓ | $3.91 – $4.69 | 0.0127 τ · @ $307.36/τ · includes ~20% buffer for fee jitter |
...
3. Fund with burn fee + buffer (~0.0153 τ recommended).
