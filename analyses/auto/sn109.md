...
| Emission / day | 57.9660 τ |
| Top-1 share | 100.0% |
| Liquidity (TAO in) | 1,270.2 τ |
| Price (τ/α) | 0.005367 |
| Age | 122 days |
...
5. `btcli subnet register --netuid 109 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- GitHub: <https://github.com/fx-integral/academia>
- Discord: <https://discord.gg/invite/m9J8QTf5JT>
- TAO.app: <https://tao.app/subnet/109>
