...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 39.7/100 · refreshes hourly
...
| Burn fee | 0.000605 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.000500 τ → 100.0000 τ |
| Emission / day | 24.8845 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 8,692.5 τ |
| Price (τ/α) | 0.003456 |
| Age | 681 days |
...
5. `btcli subnet register --netuid 42 --wallet.name <cold> --wallet.hotkey <hot>`
6. Monitor your score during the immunity window.

## Links

- TAO.app: <https://tao.app/subnet/42>
