...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 21.7/100 · refreshes hourly
...
| Emission / day | 26.7977 τ |
| Top-1 share | 95.5% |
| Liquidity (TAO in) | 7,107.0 τ |
| Price (τ/α) | 0.003443 |
| Age | 495 days |
...
- top miner incentive 96% (winner-take-all)
...
5. `btcli subnet register --netuid 65 --wallet.name <cold> --wallet.hotkey <hot>`
...
- TAO.app: <https://tao.app/subnet/65>
