...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 24.1/100 · refreshes hourly
...
| Emission / day | 27.5755 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 3,837.0 τ |
| Price (τ/α) | 0.003830 |
| Age | 370 days |
...
5. `btcli subnet register --netuid 127 --wallet.name <cold> --wallet.hotkey <hot>`
...
- TAO.app: <https://tao.app/subnet/127>
