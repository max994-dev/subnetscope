...
> Auto-analyzed: 2026-06-29 21:55 EEST · easy-entry score: 24.9/100 · refreshes hourly
...
| Burn fee | 0.001091 τ `[░░░░░░░░░░░░░░░░░░░░]` 0.0% of max |
| Burn min / max | 0.000500 τ → 100.0000 τ |
| Emission / day | 94.6900 τ |
| Top-1 share | — |
| Liquidity (TAO in) | 2,707.3 τ |
| Price (τ/α) | 0.009147 |
| Age | 137 days |


> **Trend (from 98 snapshots):** Burn fee has risen ~29% over the last 98 snapshots.

## Easy-entry score: 25 / 100  🔴 low

- subnet is FULL (eviction war)
- cheap burn fee 0.0011 τ
...
**Monthly recurring:** ~$50 – $1,500 · **One-time setup:** ~$0.23 – $0.27
...
|---|:-:|---|---|
| Registration burn fee (one-time per UID) | ✓ | $0.23 – $0.27 | 0.0011 τ · @ $209.12/τ · includes ~20% buffer for fee jitter |
...
3. Fund with burn fee + buffer (~0.0013 τ recommended).
4. Clone the subnet repo, run the miner in test mode first.
5. `btcli subnet register --netuid 126 --wallet.name <cold> --wallet.hotkey <hot>`
...
- TAO.app: <https://tao.app/subnet/126>
